package com.monkey.ultimateCrates.bukkit.database.func.vkeys.dbs;
...
public class MySQLVirtualKeyStorage implements VirtualKeyStorage {

    private final Connection connection;
    private final Logger logger;

    public MySQLVirtualKeyStorage(Connection connection, Logger logger) {
    ...
    public void createTable() {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            logger.log(Level.SEVERE, "Errore nella creazione tabella virtual_keys MySQL", e);
        }
    }
    ...
    public void giveKeys(String playerName, String crateId, int amount) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            logger.log(Level.SEVERE, "Errore nell'aggiunta di chiavi virtuali MySQL", e);
        }
    }
    ...
    public int getKeys(String playerName, String crateId) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            logger.log(Level.SEVERE, "Errore nel recupero chiavi virtuali MySQL", e);
        }
        return 0;
    }
    ...
    public Map<String, Integer> getAllKeys(String playerName) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            logger.log(Level.SEVERE, "Errore nel recupero di tutte le chiavi virtuali MySQL", e);
        }
        return keys;
    }
